import { DatePicker, FormGroup, Label, Input, useForm, Select } from '@src/components/form';
...
export const SearchFormCard = () => {
  const { isLoading, caseTypeOptions } = usePageStateContext();
  ...
  const { formData, updateFormData } = useForm<SearchCardForm>({
    ...
    caseType: { initialValue: '', validate: () => ({}) },
  });
    ...
    <SearchCard>
      ...
      >
        <div className="row">
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="setFileEndDate">提報日期(迄)</Label>
              <DatePicker
                id="setFileEndDate"
                name="setFileEndDate"
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="caseType">案件類別</Label>
              <Select
                id="caseType"
                name="caseType"
