      ...
      <Card.Body>
        <DataGrid.Table<ExternalIntelligenceModel, number>
          ...
          columnDefs={[
            ...
            { field: 'IntelligenceNo', text: '洗防處情資編號', isSortable: true, className: 'text-primary' },
            { field: 'SupervisorName', text: '洗防處承辦人', isSortable: true, className: 'text-primary' },
            { field: 'FileNo', text: '國情文號(原洗防處檔號)', isSortable: true, className: 'text-primary' },
            { field: 'CaseNo', text: '洗防處案號', isSortable: true, className: 'text-primary' },
            { field: 'CaseName', text: '洗防處案名', isSortable: true, className: 'text-primary' },
            ...
            <>
              <DataGrid.Column>
                <button
                  ...
                  onClick={() => {
                    navigation.push(RoutePath.SRC_LAUNDRY_EDIT + '/' + rowData.intelligenceNo);
                  }}
                >
