      ...
      >
        <div className="row">
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="intelligenceNo">洗防處情資編號</Label>
              <Input
                type="text"
                id="intelligenceNo"
                name="intelligenceNo"
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="supervisorName">洗防處承辦人</Label>
              <Input
                type="text"
                id="supervisorName"
                name="supervisorName"
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="fileNo">國情文號(原洗防處檔號)</Label>
              <Input
                type="text"
                id="fileNo"
                name="fileNo"
        ...
        <div className="row">
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="caseNo">洗防處案號</Label>
              <Input
                type="text"
                id="caseNo"
                name="caseNo"
          ...
          <div className="col-12 col-sm-6 col-md-4">
            <FormGroup>
              <Label htmlFor="caseName">洗防處案名</Label>
              <Input
                type="text"
                id="caseName"
                name="caseName"
