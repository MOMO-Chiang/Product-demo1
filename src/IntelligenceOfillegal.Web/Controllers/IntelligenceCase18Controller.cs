...
{
    [RoutePrefix("api/intelligenceCase18")]
    public class IntelligenceCase18Controller : ApiController
    {
        /// <summary>
        /// 單位代碼
        /// </summary>
        private readonly Department Department = Department.Domestic;
        
        private readonly IUnitOfWork _unitOfWork;
        private readonly IDbConnectionFactory _dbConnectionFactory;
        private readonly DepartmentDBInfo _departmentInfo;
        private readonly IMapper _mapper;
        public IntelligenceCase18Controller(IUnitOfWork unitOfWork, IDbConnectionFactory dbConnectionFactory, IMapper mapper)
        {
