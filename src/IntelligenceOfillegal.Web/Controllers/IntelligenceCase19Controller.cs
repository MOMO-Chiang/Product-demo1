...
{
    [RoutePrefix("api/intelligenceCase19")]
    public class IntelligenceCase19Controller : ApiController
    {
        /// <summary>
        /// 單位代碼
        /// </summary>
        private readonly Department Department = Department.Security;

        private readonly IUnitOfWork _unitOfWork;
        private readonly IDbConnectionFactory _dbConnectionFactory;
        private readonly DepartmentDBInfo _departmentInfo;
        private readonly IMapper _mapper;
        public IntelligenceCase19Controller(IUnitOfWork unitOfWork, IDbConnectionFactory dbConnectionFactory, IMapper mapper)
        {
