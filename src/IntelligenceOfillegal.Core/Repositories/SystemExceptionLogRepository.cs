...
{
    public class SystemExceptionLogRepository : RepositoryBase<SystemExceptionLog>, ISystemExceptionLogRepository
    {
        public SystemExceptionLogRepository(IDbConnectionFactory dbConnectionFactory, string connectionName)
