...
{
    public interface IRptLaundryItlgRepository : IRepositoryBase<CaseManagement>
    {
        Tuple<IEnumerable<RptLaundryItlgListModel>, int> SearchPaginated(RptLaundryItlgListSearchModel entity, PaginationWithSortedQueryModel paginated);
    }
}