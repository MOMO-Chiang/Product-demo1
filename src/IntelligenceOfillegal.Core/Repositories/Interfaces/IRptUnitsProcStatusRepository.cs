...
{
    public interface IRptUnitsProcStatusRepository : IRepositoryBase<CaseManagement>
    {
        Tuple<IEnumerable<RptUnitsProcStatusListModel>, int> SearchPaginated(RptUnitsProcStatusListSearchModel entity, PaginationWithSortedQueryModel paginated);
    }
}