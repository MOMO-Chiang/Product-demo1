...
{
    public interface IRptIncorruptionItlgRepository : IRepositoryBase<CaseManagement>
    {
        Tuple<IEnumerable<RptIncorruptionItlgListModel>, int> SearchPaginated(RptIncorruptionItlgListSearchModel entity, PaginationWithSortedQueryModel paginated);
    }
}